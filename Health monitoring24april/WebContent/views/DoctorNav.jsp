...
<div  id="navi" class="topnav">
  <a   href="DoctorChoice.jsp"><i class="fa fa-home" style="font-size:1.4em;"></i></a>
  <a href="DoctorProfile.jsp" ><i style="top:3px;"></i><span>Profile</span></a>
  <a href="ForgotDoctor.jsp" ><i style="top:3px;"></i><span>Change Password</span></a>
  <a onclick="f()" href="logout" style="width:max-content;   left:1770px;   overflow:auto;  text-align: right; right:0; top:-4px;height:50px color:black;font-size:17px;     float: right;
    color: black; text-align: center; padding: 14px 16px;text-decoration: none;font-size: 18px; font-weight:900;"><i class="fa fa-power-off"></i>  <%=user.getfName()%></a>
