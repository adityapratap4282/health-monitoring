...
<script>
	function validate() {
		...
		if (document.docReg.emailid.value == "") {
			alert('Please provide a valid Reg. Number');
			email.focus();
		...
		<div class="col-md-6">
			<div class="card">
				...
				<h4 class="card-title mt-2"
					style="color: #85D6CB; margin-top: 10px; font-size: 26px; font-weight: 600; display: elevation:inline-block;">Registration
					Form</h4>
				</header>
				<article class="card-body">


				<form action="SignUpFilterDoctor.do" name="docReg" method="post"
					...
					<div class="form-group">
						<label>Registration No</label> <input type="text" id="emailid"
							class="form-control" placeholder="" name="emailid"> <small
							class="form-text text-muted"> Please enter your number
							registered in Hospital.</small>
					</div>
					<!-- form-group end.// -->
					<div class="form-group">
					...
					<div class="form-group">
						...
						<small class="form-text text-muted">Must contain at least
							one number and one uppercase and lowercase letter, and at least 8
					...
					<div class="form-group">
						<button type="submit" class="btn btn-primary btn-block"
							style="background-color: #85D6CB; border-color: #85D6CB; padding: 10px; margin-top: 5px; margin-bottom: 5px; transition: color .15s ease-in-out, background-color .15s ease-in-out, border-color .15s ease-in-out, box-shadow .15s ease-in-out;">
							Register</button>
					</div>
					<!-- form-group// -->
					<div
